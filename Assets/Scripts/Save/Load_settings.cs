...
public class Load_settings : MonoBehaviour {
	...
	private void Awake(){
		...
		if (Application.platform != RuntimePlatform.Android) {
			Path = Application.dataPath + "/Save_game/Save_settings_" + Application.productName + ".xml";
		}
		//Если игра на Андроид
		else {
			Path = Application.persistentDataPath + "/Save_game/Save_settings_" + Application.productName + ".xml";
		}
